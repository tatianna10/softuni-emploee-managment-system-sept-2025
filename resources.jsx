      ...
      <form>
        <div className="form-row">
          <div className="form-group">
            <label htmlForfor="firstName">First name</label>
        ...
        <div className="form-group long-line">
          <label htmlForfor="imageUrl">Image Url</label>
          <div className="input-wrapper">
        ...
        <div className="form-row">
          <div className="form-group">
            <label htmlForfor="country">Country</label>
            <div className="input-wrapper">
        ...
        <div className="form-row">
          <div className="form-group">
            <label htmlForfor="street">Street</label>
            <div className="input-wrapper">
              <span><i className="fa-solid fa-map"></i></span>
          ...
          <div className="form-group">
            <label htmlForfor="streetNumber">Street number</label>
            <div className="input-wrapper">
